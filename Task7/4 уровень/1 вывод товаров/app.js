...
function showCategory(category) {
  const CategoryProductsRes = products[category];

  // let markUpToProductsDiv = createElement('div');
  // markUpToProductsDiv.insertAdjacentElement("afterbegin", productEl);
  CategoryProductsRes.forEach(function (product) {
    let markUpToProductsDiv = document.createElement('div')
    markUpToProductsDiv.innerHTML = getProductMarkup(product);
    console.log(markUpToProductsDiv)
    productEl.insertAdjacentElement("afterbegin", markUpToProductsDiv);
  });
...
console.log(getProductMarkup(products))